    ...
    <body>
        ...
        <div class="alumni-form-container">
            ...
            <div class="right-side-addalumni">
                ...
                <input name="middlename" type="text" class="text-box-top-addalumni2" placeholder="Middlename" required/><input name="age" type="number" class="text-box-top-addalumni2" placeholder="Age" required/><input name="contactnumber" type="number" class="text-box-top-addalumni2" placeholder="Contact Number" required/>
